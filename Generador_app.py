...
for concepto in concepto_list:
    ...
    cajas_texto.grid(row=contador,column=0,sticky=W, padx=5, pady=5)
    ...
    concepto_contador_ent_2.append(Entry(concepto_frame_lbl, font=("Helvetica",18), relief=FLAT, justify=CENTER, bd=1, width=5, state=DISABLED, fg=color_primario, bg=color_claro))
    concepto_contador_ent_2[contador].grid(row=contador,column=2,sticky=W)
    concepto_contador_ent_3.append(Entry(concepto_frame_lbl, font=("Helvetica",18), relief=FLAT, justify=CENTER, bd=1, width=5, state=DISABLED, fg=color_primario, bg=color_claro))
