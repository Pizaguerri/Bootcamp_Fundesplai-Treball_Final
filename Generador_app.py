...
#Frames 
top_frame = Frame(main,bd=5,relief=FLAT,bg="RoyalBlue")
left_frame = Frame(main,bd=5,relief=FLAT,bg="RoyalBlue")
right_frame = Frame(main,bd=5,relief=FLAT,bg="RoyalBlue")
bottom_frame = Frame(main,bd=5,relief=FLAT,bg="RoyalBlue")
...
concepto_frame_lbl = LabelFrame(concepto_frame,font=("Helvetica",18),text="Concepto",fg="Black",bg="RoyalBlue")
concepto_frame_lbl.pack(side=TOP)

funciones_frame = Frame(top_frame,bd=0,relief=FLAT)
funciones_frame.grid(row=1,column=0)
funciones_frame_lbl = LabelFrame(funciones_frame,font=("Helvetica",18),text="Funciones",fg="Black",bg="RoyalBlue")
